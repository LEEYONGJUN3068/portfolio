...
const Header = () => {
  ...
  return (
    <header className="w-full px-6 py-4 flex justify-between items-center bg-white dark:bg-zinc-900 shadow-sm fixed left-0 top-0 z-50">
      <Link to="/"><h1 className="text-xl font-bold text-zinc-800 dark:text-white">My</h1></Link>
      
      <nav className="space-x-6 md:flex">
        <Link to="#hero" className="text-zinc-700 dark:text-zinc-200 hover:underline">About</Link>
