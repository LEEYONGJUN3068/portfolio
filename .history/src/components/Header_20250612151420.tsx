...
const Header = () => {
  ...
  return (
    <header className="w-full px-6 py-4 flex justify-between items-center bg-white dark:bg-zinc-900 shadow-sm fixed top-0 z-50">
      <h1 className="text-xl font-bold text-zinc-800 dark:text-white">My Portfolio</h1>
